...
TEST(SPHERE, NoIntersect2d)
{
        Sphere2df sphere1 = { {1.0f, 1.0f}, 1.0f };
        Sphere2df sphere2 = { {4.0f, 4.0f}, 0.5f };

        EXPECT_FALSE(sphere1.intersects(sphere2) || sphere2.intersects(sphere1));
}

TEST(SPHERE, Intersect2d)
{
        Sphere2df sphere1 = { {1.0f, 1.0f}, 1.0f };
        Sphere2df sphere2 = { {1.1f, 1.1f}, 1.0f };

        EXPECT_TRUE(sphere1.intersects(sphere2) && sphere2.intersects(sphere1));
}

TEST(SPHERE, Touch2d_1)
{
        Sphere2df sphere1 = { {1.0f, 1.0f}, 1.0f };
        Sphere2df sphere2 = { {1.0f, 3.0f}, 1.0f };

        EXPECT_TRUE(sphere1.intersects(sphere2) && sphere2.intersects(sphere1));
}

TEST(SPHERE, NotInside)
{
        Sphere2df sphere1 = { {1.0f, 1.0f}, 1.0f };
        Vector2df vector = { 4.0f, 4.0f };

        EXPECT_FALSE(sphere1.inside(vector));
}

TEST(SPHERE, Inside)
{
        Sphere2df sphere1 = { {0.0f, 0.0f}, 1.0f };
        Vector2df vector = { 0.0f, 0.0f };

        EXPECT_TRUE(sphere1.inside(vector));
}

TEST(SPHERE, TouchPoint)
{
        Sphere2df sphere1 = { {0.0f, 0.0f}, 1.0f };
